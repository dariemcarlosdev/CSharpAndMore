...
namespace ABSTRACT_MEMBERS
{
    public class StaticNonStaticConstructor
    {
        ...
        */
        ...
        //the static constructor is the fast block of code that gets executes under a class. No matter how many numbers of objects you created for the class the static constructor is executed only once.
